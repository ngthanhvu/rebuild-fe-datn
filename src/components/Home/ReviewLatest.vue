<template>
    <div class="mt-3 bg-white p-8 rounded-[10px]">
        <div class="flex justify-between items-center mb-6">
            ...
            <NuxtLink to="/reviews" class="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                Xem tất cả →
            </NuxtLink>
        </div>

        <div class="mb-10">
            <Swiper v-if="reviews.length > 3" :modules="[Pagination]" :slides-per-view="1" :space-between="16"
                :breakpoints="{
